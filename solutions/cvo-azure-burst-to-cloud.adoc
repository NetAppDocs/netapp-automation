...
= Cloud Volumes ONTAP Deployment for Azure using Terraform
:hardbreaks:
:nofooter:
:icons: font
:linkattrs:
...
[.lead]
This article supports the Cloud Volumes ONTAP for Azure Automation Solution, which is available to NetApp customers from the BlueXP Automation Catalog. 

The Cloud Volumes ONTAP for Azure Automation Solution automates the containerized automated deployment of Cloud Volumes ONTAP for Azure using Terraform, enabling you to deploy Cloud Volumes ONTAP for Azure rapidly, without any manual intervention.
