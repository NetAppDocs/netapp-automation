...
[.lead]
This solution outlines the containerized automated deployment of Cloud Volumes ONTAP for Azure using Terraform, enabling you to create and build Cloud Volumes ONTAP for Azure rapidly, without any manual intervention.
...
+
The examples shown below enables FlexCache and FlexClone:
+
