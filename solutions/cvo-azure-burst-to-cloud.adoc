...
* You must download the link:https://console.netapp.com/automationCatalog[Cloud Volumes ONTAP Azure - Burst to cloud^] automation solution through the Console web UI. The solution is packaged as `CVO-Azure-Burst-To-Cloud.zip`.
...
. From the Azure portal, navigate to *SaaS* and select *Subscribe to NetApp Intelligent Services*.
