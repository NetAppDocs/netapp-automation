...
. Create a service account with permissions to deploy Cloud Volumes ONTAP and the BluXP Connector in the GCP account.
. Download the key file for the account and update the cxo-automation-gcp.json file  under cvo_gcp_variables. 
+
.Example
+
----
