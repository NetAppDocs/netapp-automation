...
* You must download the link:https://console.netapp.com/automationCatalog[Cloud Volumes ONTAP for Google Cloud - Burst to cloud^] automation solution through the Console web UI. The solution is packaged as `cvo_gcp_flexcache.zip`.
...
== Step 4: Sign up for NetApp Intelligent Services
...
. Navigate to the link:https://console.cloud.google.com/marketplace/product/netapp-cloudmanager/cloud-manager[Google Cloud console^] and select *Subscribe to NetApp Intelligent Services*.

. Configure the NetApp Console portal to import the SaaS subscription to the Console.
+
...
For more information, see link:https://docs.netapp.com/us-en/console-setup-admin/task-adding-gcp-accounts.html#associate-a-marketplace-subscription-with-google-cloud-credentials[Manage Google Cloud credentials and subscriptions for NetApp Console^].
