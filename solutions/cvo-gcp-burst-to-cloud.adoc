...
. Create a service account with permissions to deploy Cloud Volumes ONTAP and the BlueXP Connector in the Google Cloud account. link:https://cloud.google.com/iam/docs/service-accounts-create[Learn more about creating service accounts.^]
