...
* You need to download the https://console.netapp.com/automationHub[Amazon FSx for NetApp ONTAP management - Burst to cloud^] automation solution through the NetApp Console web UI. The solution is packaged as file `AWS_FSxN_BTC.zip`.
