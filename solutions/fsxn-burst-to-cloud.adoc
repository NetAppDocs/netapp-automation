...
* You need to download the https://console.bluexp.netapp.com/automationCatalog[Amazon FSx for NetApp ONTAP - Burst to cloud^] automation solution through the NetApp Console web UI. The solution is packaged as file `AWS_FSxN_BTC.zip`.
