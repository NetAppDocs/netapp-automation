...
summary: You can use this automation solution to provision Amazon FSx for NetApp ONTAP management with volumes and an associated FlexCache.
---
...
[.lead]
You can use this automation solution to provision Amazon FSx for NetApp ONTAP management with volumes and an associated FlexCache.

[NOTE]
Amazon FSx for NetApp ONTAP management is also referred to as *FSx for ONTAP*.
...
* You need to download the https://console.netapp.com/automationCatalog[Amazon FSx for NetApp ONTAP management - Burst to cloud^] automation solution through the NetApp Console web UI. The solution is packaged as file `AWS_FSxN_BTC.zip`.
...
== Step 6: Provision Amazon FSx for NetApp ONTAP management and FlexCache

You can provision Amazon FSx for NetApp ONTAP management and FlexCache.
...
== Step 7: Destroy Amazon FSx for NetApp ONTAP management and FlexCache

You can optionally delete and remove Amazon FSx for NetApp ONTAP management and FlexCache.
