...
* You need to download the https://console.bluexp.netapp.com/automationCatalog[FSxN - Burst to cloud^] automation solution through the BlueXP web user interface. The solution is packaged as file `AWS_FSxN_BTC.zip`.
