...
* You must download the link:https://console.netapp.com/automationCatalog[Cloud Volumes ONTAP AWS - Burst to cloud^] automation solution through the Console web UI. The solution is packaged as `cvo_aws_flexcache.zip`.
...
. From the Amazon Web Services (AWS) portal, navigate to *SaaS* and select *Subscribe to NetApp Intelligent Services*.
+
