...
* You need to download the https://console.bluexp.netapp.com/automationCatalog[ANF - Oracle^] automation solution through the BlueXP web user interface. The solution is packaged as file `Ora_ANF_Prov.zip`.
