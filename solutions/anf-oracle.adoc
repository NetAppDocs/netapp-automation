...
* You need to download the https://console.netapp.com/automationCatalog[Oracle using Azure NetApp Files^] automation solution through the NetApp Console web UI. The solution is packaged as file `na_oracle19c_deploy-master.zip`.
