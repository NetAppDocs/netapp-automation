...
[.lead]
You can use the ONTAP day 0/1 automation solution to deploy and configure an ONTAP cluster using Ansible. The solution is available from the link:https://console.netapp.com/automationHub[NetApp Console automation hub^].
