...
. Navigate to the tutorial-requests.txt file and copy the content from line 11 to line 165. Paste the contents under the `raw service request` variable in the new `cluster_initial.yml` file in the `logic-tasks` folder.
+
Example:
+
----
