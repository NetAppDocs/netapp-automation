...
NOTE: "NetApp123!" is a temporary password to decrypt the `vault.yml` file and the corresponding vault password. You will be prompted to change this to your own password for future use.
