...
The following example commands dynamically defines a service request for each cluster using the `tutorial-requests.yml` file:
...
== Step 6: Deploy the ONTAP day 0, day 1, and health check services
...
Use the following commands to deploy the ONTAP day 0, ONTAP day 1 solution and verify the health of your deployment:
