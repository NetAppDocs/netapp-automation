...
. Download the link:https://console.netapp.com/automationCatalog[ONTAP - Day 0/1 & Health Checks^] automation solution through the Console web UI. The solution is packaged as `ONTAP_DAY0_DAY1.zip`.
+
