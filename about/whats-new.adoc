...
The https://console.netapp.com/automationHub[NetApp Console automation hub^] is available through the Console web user interface. The automation hub provides access to solutions that can help you with the automated deployment and integration of NetApp products. The documentation for these solutions is organized in several different product or functional areas as described below.
