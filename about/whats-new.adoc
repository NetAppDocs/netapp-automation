...
The https://console.bluexp.netapp.com/automationCatalog[NetApp Console automation catalog^] is available through the Console web user interface. The automation catalog provides access to solutions that can help you with the automated deployment and integration of NetApp products. The documentation for these solutions is organized in several different product or functional areas as described below.
